...
class MODEL():
    ...
    def SetupCamera(self):
        ...
        detection_output = YOLO_model.predict(source="Models\\YOLOInput\\Yoloimage.jpg", conf=0.3, save=False,device='cpu')
        detection_output_Person = Yolo_model_person_detector.predict(source="Models\\YOLOInput\\Yoloimage.jpg", conf=0.3, save=False,device='cpu')
